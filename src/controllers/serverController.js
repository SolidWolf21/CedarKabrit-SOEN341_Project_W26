...
app.use("/favicons", express.static(path.join(publicDir, "favicons")));
...
app.get("/signup", (req, res) => {
    res.sendFile(path.join(viewsDir, "sign-up.html"));
});

app.get("/signin", (req, res) => {
    res.sendFile(path.join(viewsDir, "sign-in.html"));
});
...
app.get("/recipes/new", (req, res) => {
    res.sendFile(path.join(viewsDir, "new-recipe.html"));
});

app.get("/recipes/mine", (req, res) => {
    res.sendFile(path.join(viewsDir, "my-recipes.html"));
});

app.get("/recipes/browse", (req, res) => {
    res.sendFile(path.join(viewsDir, "browse-recipes.html"));
});

app.get("/planner/weekly", (req, res) => {
    res.sendFile(path.join(viewsDir, "weekly-planner.html"));
});
